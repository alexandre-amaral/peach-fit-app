    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description"> Preencha os dados abaixo para adicionar um novo Cliente. </p>
                @if($errors->any())
                ...
                @endif
                <form class="forms-sample" action="{{ route('admin.register.customer') }}" enctype="multipart/form-data" method="POST">
                    @csrf
