...
//Evento de criação de uma interação cliente/personal, onde o personal aceita o agendamento do cliente

class TrainingSessionAccepted implements ShouldBroadcast
{
